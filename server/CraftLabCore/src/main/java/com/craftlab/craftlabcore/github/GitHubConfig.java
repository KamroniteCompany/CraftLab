...
/**
 * Lit un éventuel token GitHub depuis config/craftlabcore/config.properties (clé github_token),
    ...
    private static void writeBack(Path configFile, Properties properties) {
        try {
            ...
            try (var out = Files.newOutputStream(configFile)) {
                properties.store(out, "Config CraftLabCore. github_token est optionnel : laissez vide pour "
