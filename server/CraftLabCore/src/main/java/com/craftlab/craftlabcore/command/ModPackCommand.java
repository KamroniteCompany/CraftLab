...
import com.craftlab.craftlabcore.modpack.ApplyResult;
import com.craftlab.craftlabcore.modpack.LauncherModPackExporter;
import com.craftlab.craftlabcore.modpack.ModPack;
import com.craftlab.craftlabcore.modpack.ModPackApplier;
import com.craftlab.craftlabcore.modpack.ModPackDiff;
import com.craftlab.craftlabcore.modpack.ModPackEntry;
...
public final class ModPackCommand {
        ...
        dispatcher.register(
            Commands.literal("modpack")
                ...
                .then(Commands.literal("export")
                    .executes(ModPackCommand::runExport))
        );
    }
    ...
    private static int runExport(CommandContext<CommandSourceStack> ctx) {
        ModPack current = ModPackManager.get().getCurrent();
        LauncherModPackExporter.export(current);
        ctx.getSource().sendSuccess(() -> Component.literal(
            "current-modpack-launcher.json régénéré (config/craftlabcore/modpack/)."), true);
        return 1;
    }
