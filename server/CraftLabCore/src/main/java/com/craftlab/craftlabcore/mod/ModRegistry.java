 ...
 * "craftlabcore" (le mod cœur lui-même, anciennement nommé "communitytest") n'est qu'une
 * entrée comme une autre, enregistrée automatiquement au tout premier démarrage (voir
 * loadOrBootstrap) pour ne pas casser le mod existant.
 */
public final class ModRegistry {
     ...
     * démarrage du serveur), enregistre automatiquement CraftLabCore par défaut puis sauvegarde,
     * pour que le mod existant reste utilisable sans étape manuelle. Un /mod unregister
     * craftlabcore ultérieur ne sera pas annulé au prochain redémarrage, puisque le fichier
