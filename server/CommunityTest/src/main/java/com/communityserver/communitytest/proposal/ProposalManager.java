 ...
 * N'accorde AUCUN traitement spécial à "communitytest" : tout modId est traité de façon
 * strictement identique ici. La façade de compatibilité (/communitytest) est la seule
 * couche du code à connaître ce nom en dur.
 */
